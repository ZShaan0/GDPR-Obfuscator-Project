...
class TestOutPutDataBody:
    def test_obfuscated_df_is_converted_to_a_byte_stream_representation_of_a_file(self):
        # ARRANGE
    ...
    def test_output_data_body_is_compatible_with_boto3_putobject(self):
        ...
        # ACT
        s3.put_object(Bucket="my_ingestion_bucket", Key="obfuscated_data/file1.csv", Body=obfuscated_data_body)

        uploaded_object = s3.get_object(Bucket="my_ingestion_bucket", Key="obfuscated_data/file1.csv")
